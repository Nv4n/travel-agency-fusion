...
export const UserScalarFieldEnumSchema = z.enum(['id','email','roles','fname','lname','createdAt','updatedAt']);

export const PasswordScalarFieldEnumSchema = z.enum(['hash','userId']);

export const ChatScalarFieldEnumSchema = z.enum(['id']);

export const MessageScalarFieldEnumSchema = z.enum(['id','content','chatId','userId']);

export const ReviewScalarFieldEnumSchema = z.enum(['id','rating','content','createdAt','propertyId','userId']);

export const ReservationScalarFieldEnumSchema = z.enum(['id','price','from','to','roomId','userId']);

export const PropertyScalarFieldEnumSchema = z.enum(['id','description','ownerId']);

export const RoomScalarFieldEnumSchema = z.enum(['id','quantity','maxGuests','price','hotelId']);

export const FacilityScalarFieldEnumSchema = z.enum(['id','description','category','icon']);
...
export const CategorySchema = z.enum(['ROOM','FOOD','WELLNESS','MISCELLANEOUS']);

export type CategoryType = `${z.infer<typeof CategorySchema>}`

export const IconSchema = z.enum(['BED','WIFI','FITNESS','RESTAURANT','NOSMOKE','SOUNDPROOF','BAR','AC','PARKING','SPA','BREAKFAST','FRIDGE','KITCHEN']);
...
export const UserWithRelationsSchema: z.ZodType<UserWithRelations> = UserSchema.merge(z.object({
  password: z.lazy(() => PasswordWithRelationsSchema).nullable(),
  ...
  Chat: z.lazy(() => ChatWithRelationsSchema).array(),
}))
...
export type ChatRelations = {
  messages: MessageWithRelations[];
  participants: UserWithRelations[];
};

export type ChatWithRelations = z.infer<typeof ChatSchema> & ChatRelations

export const ChatWithRelationsSchema: z.ZodType<ChatWithRelations> = ChatSchema.merge(z.object({
  messages: z.lazy(() => MessageWithRelationsSchema).array(),
  participants: z.lazy(() => UserWithRelationsSchema).array(),
}))
...
export const MessageWithRelationsSchema: z.ZodType<MessageWithRelations> = MessageSchema.merge(z.object({
  chat: z.lazy(() => ChatWithRelationsSchema),
  User: z.lazy(() => UserWithRelationsSchema),
}))
...
export const RoomWithRelationsSchema: z.ZodType<RoomWithRelations> = RoomSchema.merge(z.object({
  hotel: z.lazy(() => PropertyWithRelationsSchema),
  reservations: z.lazy(() => ReservationWithRelationsSchema).array(),
  facilities: z.lazy(() => FacilityWithRelationsSchema).array(),
}))
...
// FACILITY RELATION SCHEMA
//------------------------------------------------------

export type FacilityRelations = {
  rooms: RoomWithRelations[];
};

export type FacilityWithRelations = z.infer<typeof FacilitySchema> & FacilityRelations

export const FacilityWithRelationsSchema: z.ZodType<FacilityWithRelations> = FacilitySchema.merge(z.object({
  rooms: z.lazy(() => RoomWithRelationsSchema).array(),
}))
...
export const PasswordArgsSchema: z.ZodType<Prisma.PasswordArgs> = z.object({
...
export const ChatIncludeSchema: z.ZodType<Prisma.ChatInclude> = z.object({
  messages: z.union([z.boolean(),z.lazy(() => MessageFindManyArgsSchema)]).optional(),
  participants: z.union([z.boolean(),z.lazy(() => UserFindManyArgsSchema)]).optional(),
...
export const PropertyCountOutputTypeArgsSchema: z.ZodType<Prisma.PropertyCountOutputTypeArgs> = z.object({
...
export const RoomIncludeSchema: z.ZodType<Prisma.RoomInclude> = z.object({
  hotel: z.union([z.boolean(),z.lazy(() => PropertyArgsSchema)]).optional(),
  reservations: z.union([z.boolean(),z.lazy(() => ReservationFindManyArgsSchema)]).optional(),
  facilities: z.union([z.boolean(),z.lazy(() => FacilityFindManyArgsSchema)]).optional(),
...
export const FacilityIncludeSchema: z.ZodType<Prisma.FacilityInclude> = z.object({
  rooms: z.union([z.boolean(),z.lazy(() => RoomFindManyArgsSchema)]).optional(),
  _count: z.union([z.boolean(),z.lazy(() => FacilityCountOutputTypeArgsSchema)]).optional(),
}).strict()

export const FacilityArgsSchema: z.ZodType<Prisma.FacilityArgs> = z.object({
  select: z.lazy(() => FacilitySelectSchema).optional(),
  include: z.lazy(() => FacilityIncludeSchema).optional(),
}).strict();

export const FacilityCountOutputTypeArgsSchema: z.ZodType<Prisma.FacilityCountOutputTypeArgs> = z.object({
  select: z.lazy(() => FacilityCountOutputTypeSelectSchema).nullish(),
}).strict();

export const FacilityCountOutputTypeSelectSchema: z.ZodType<Prisma.FacilityCountOutputTypeSelect> = z.object({
  rooms: z.boolean().optional(),
}).strict();
...
export const UserWhereInputSchema: z.ZodType<Prisma.UserWhereInput> = z.object({
  ...
  lname: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  password: z.union([ z.lazy(() => PasswordRelationFilterSchema),z.lazy(() => PasswordWhereInputSchema) ]).optional().nullable(),
...
export const UserScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.UserScalarWhereWithAggregatesInput> = z.object({
  ...
  lname: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
...
export const ChatOrderByWithRelationInputSchema: z.ZodType<Prisma.ChatOrderByWithRelationInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  messages: z.lazy(() => MessageOrderByRelationAggregateInputSchema).optional(),
  participants: z.lazy(() => UserOrderByRelationAggregateInputSchema).optional()
}).strict();
...
export const RoomWhereInputSchema: z.ZodType<Prisma.RoomWhereInput> = z.object({
  ...
  maxGuests: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
  price: z.union([ z.lazy(() => FloatFilterSchema),z.number() ]).optional(),
  hotelId: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  hotel: z.union([ z.lazy(() => PropertyRelationFilterSchema),z.lazy(() => PropertyWhereInputSchema) ]).optional(),
  reservations: z.lazy(() => ReservationListRelationFilterSchema).optional(),
...
export const RoomOrderByWithRelationInputSchema: z.ZodType<Prisma.RoomOrderByWithRelationInput> = z.object({
  ...
  hotel: z.lazy(() => PropertyOrderByWithRelationInputSchema).optional(),
  reservations: z.lazy(() => ReservationOrderByRelationAggregateInputSchema).optional(),
  facilities: z.lazy(() => FacilityOrderByRelationAggregateInputSchema).optional()
}).strict();
...
export const RoomScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.RoomScalarWhereWithAggregatesInput> = z.object({
  ...
  maxGuests: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
  price: z.union([ z.lazy(() => FloatWithAggregatesFilterSchema),z.number() ]).optional(),
  hotelId: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
}).strict();

export const FacilityWhereInputSchema: z.ZodType<Prisma.FacilityWhereInput> = z.object({
  AND: z.union([ z.lazy(() => FacilityWhereInputSchema),z.lazy(() => FacilityWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => FacilityWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => FacilityWhereInputSchema),z.lazy(() => FacilityWhereInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  description: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  category: z.union([ z.lazy(() => EnumCategoryFilterSchema),z.lazy(() => CategorySchema) ]).optional(),
  icon: z.union([ z.lazy(() => EnumIconFilterSchema),z.lazy(() => IconSchema) ]).optional(),
  rooms: z.lazy(() => RoomListRelationFilterSchema).optional()
}).strict();
...
export const FacilityOrderByWithAggregationInputSchema: z.ZodType<Prisma.FacilityOrderByWithAggregationInput> = z.object({
  ...
  category: z.lazy(() => SortOrderSchema).optional(),
  icon: z.lazy(() => SortOrderSchema).optional(),
  _count: z.lazy(() => FacilityCountOrderByAggregateInputSchema).optional(),
  _max: z.lazy(() => FacilityMaxOrderByAggregateInputSchema).optional(),
  _min: z.lazy(() => FacilityMinOrderByAggregateInputSchema).optional()
}).strict();

export const FacilityScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.FacilityScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => FacilityScalarWhereWithAggregatesInputSchema),z.lazy(() => FacilityScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => FacilityScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => FacilityScalarWhereWithAggregatesInputSchema),z.lazy(() => FacilityScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  description: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  category: z.union([ z.lazy(() => EnumCategoryWithAggregatesFilterSchema),z.lazy(() => CategorySchema) ]).optional(),
  icon: z.union([ z.lazy(() => EnumIconWithAggregatesFilterSchema),z.lazy(() => IconSchema) ]).optional(),
}).strict();
...
export const UserCreateInputSchema: z.ZodType<Prisma.UserCreateInput> = z.object({
  ...
  reservations: z.lazy(() => ReservationCreateNestedManyWithoutUserInputSchema).optional(),
  ...
  Chat: z.lazy(() => ChatCreateNestedManyWithoutParticipantsInputSchema).optional()
}).strict();
...
export const UserUncheckedCreateInputSchema: z.ZodType<Prisma.UserUncheckedCreateInput> = z.object({
  ...
  reservations: z.lazy(() => ReservationUncheckedCreateNestedManyWithoutUserInputSchema).optional(),
  ...
  Chat: z.lazy(() => ChatUncheckedCreateNestedManyWithoutParticipantsInputSchema).optional()
}).strict();
...
export const UserUpdateInputSchema: z.ZodType<Prisma.UserUpdateInput> = z.object({
  ...
  lname: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  password: z.lazy(() => PasswordUpdateOneWithoutUserNestedInputSchema).optional(),
  reservations: z.lazy(() => ReservationUpdateManyWithoutUserNestedInputSchema).optional(),
  ...
  Chat: z.lazy(() => ChatUpdateManyWithoutParticipantsNestedInputSchema).optional()
}).strict();
...
export const UserUncheckedUpdateInputSchema: z.ZodType<Prisma.UserUncheckedUpdateInput> = z.object({
  ...
  reservations: z.lazy(() => ReservationUncheckedUpdateManyWithoutUserNestedInputSchema).optional(),
  ...
  Chat: z.lazy(() => ChatUncheckedUpdateManyWithoutParticipantsNestedInputSchema).optional()
}).strict();
...
export const ChatCreateInputSchema: z.ZodType<Prisma.ChatCreateInput> = z.object({
  ...
  participants: z.lazy(() => UserCreateNestedManyWithoutChatInputSchema).optional()
}).strict();
...
export const ChatUncheckedCreateInputSchema: z.ZodType<Prisma.ChatUncheckedCreateInput> = z.object({
  ...
  participants: z.lazy(() => UserUncheckedCreateNestedManyWithoutChatInputSchema).optional()
}).strict();
...
export const ChatUpdateInputSchema: z.ZodType<Prisma.ChatUpdateInput> = z.object({
  ...
  participants: z.lazy(() => UserUpdateManyWithoutChatNestedInputSchema).optional()
}).strict();
...
export const ChatUncheckedUpdateInputSchema: z.ZodType<Prisma.ChatUncheckedUpdateInput> = z.object({
  ...
  participants: z.lazy(() => UserUncheckedUpdateManyWithoutChatNestedInputSchema).optional()
}).strict();
...
export const ReservationCreateInputSchema: z.ZodType<Prisma.ReservationCreateInput> = z.object({
  ...
  from: z.coerce.date(),
  to: z.coerce.date(),
  room: z.lazy(() => RoomCreateNestedOneWithoutReservationsInputSchema),
  user: z.lazy(() => UserCreateNestedOneWithoutReservationsInputSchema)
}).strict();
...
export const ReservationUpdateInputSchema: z.ZodType<Prisma.ReservationUpdateInput> = z.object({
  ...
  room: z.lazy(() => RoomUpdateOneRequiredWithoutReservationsNestedInputSchema).optional(),
  user: z.lazy(() => UserUpdateOneRequiredWithoutReservationsNestedInputSchema).optional()
}).strict();
...
export const PropertyCreateInputSchema: z.ZodType<Prisma.PropertyCreateInput> = z.object({
  ...
  rooms: z.lazy(() => RoomCreateNestedManyWithoutHotelInputSchema).optional(),
...
export const PropertyUncheckedCreateInputSchema: z.ZodType<Prisma.PropertyUncheckedCreateInput> = z.object({
  ...
  description: z.string(),
  ownerId: z.string(),
  rooms: z.lazy(() => RoomUncheckedCreateNestedManyWithoutHotelInputSchema).optional(),
...
export const PropertyUpdateInputSchema: z.ZodType<Prisma.PropertyUpdateInput> = z.object({
  ...
  rooms: z.lazy(() => RoomUpdateManyWithoutHotelNestedInputSchema).optional(),
...
export const PropertyUncheckedUpdateInputSchema: z.ZodType<Prisma.PropertyUncheckedUpdateInput> = z.object({
  ...
  rooms: z.lazy(() => RoomUncheckedUpdateManyWithoutHotelNestedInputSchema).optional(),
...
export const RoomCreateInputSchema: z.ZodType<Prisma.RoomCreateInput> = z.object({
  ...
  facilities: z.lazy(() => FacilityCreateNestedManyWithoutRoomsInputSchema).optional()
}).strict();
...
export const RoomUncheckedCreateInputSchema: z.ZodType<Prisma.RoomUncheckedCreateInput> = z.object({
  ...
  facilities: z.lazy(() => FacilityUncheckedCreateNestedManyWithoutRoomsInputSchema).optional()
}).strict();

export const RoomUpdateInputSchema: z.ZodType<Prisma.RoomUpdateInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  quantity: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  maxGuests: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  price: z.union([ z.number(),z.lazy(() => FloatFieldUpdateOperationsInputSchema) ]).optional(),
  hotel: z.lazy(() => PropertyUpdateOneRequiredWithoutRoomsNestedInputSchema).optional(),
  reservations: z.lazy(() => ReservationUpdateManyWithoutRoomNestedInputSchema).optional(),
  facilities: z.lazy(() => FacilityUpdateManyWithoutRoomsNestedInputSchema).optional()
}).strict();
...
export const RoomUncheckedUpdateInputSchema: z.ZodType<Prisma.RoomUncheckedUpdateInput> = z.object({
  ...
  facilities: z.lazy(() => FacilityUncheckedUpdateManyWithoutRoomsNestedInputSchema).optional()
}).strict();
...
export const FacilityCreateInputSchema: z.ZodType<Prisma.FacilityCreateInput> = z.object({
  id: z.string().cuid().optional(),
  description: z.string(),
  category: z.lazy(() => CategorySchema),
  icon: z.lazy(() => IconSchema),
  rooms: z.lazy(() => RoomCreateNestedManyWithoutFacilitiesInputSchema).optional()
}).strict();
...
export const FacilityUncheckedCreateInputSchema: z.ZodType<Prisma.FacilityUncheckedCreateInput> = z.object({
  ...
  category: z.lazy(() => CategorySchema),
  icon: z.lazy(() => IconSchema),
  rooms: z.lazy(() => RoomUncheckedCreateNestedManyWithoutFacilitiesInputSchema).optional()
}).strict();
...
export const FacilityUpdateInputSchema: z.ZodType<Prisma.FacilityUpdateInput> = z.object({
  ...
  icon: z.union([ z.lazy(() => IconSchema),z.lazy(() => EnumIconFieldUpdateOperationsInputSchema) ]).optional(),
  rooms: z.lazy(() => RoomUpdateManyWithoutFacilitiesNestedInputSchema).optional()
}).strict();
...
export const FacilityUncheckedUpdateInputSchema: z.ZodType<Prisma.FacilityUncheckedUpdateInput> = z.object({
  ...
  category: z.union([ z.lazy(() => CategorySchema),z.lazy(() => EnumCategoryFieldUpdateOperationsInputSchema) ]).optional(),
  icon: z.union([ z.lazy(() => IconSchema),z.lazy(() => EnumIconFieldUpdateOperationsInputSchema) ]).optional(),
  rooms: z.lazy(() => RoomUncheckedUpdateManyWithoutFacilitiesNestedInputSchema).optional()
}).strict();
...
export const FacilityUpdateManyMutationInputSchema: z.ZodType<Prisma.FacilityUpdateManyMutationInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  category: z.union([ z.lazy(() => CategorySchema),z.lazy(() => EnumCategoryFieldUpdateOperationsInputSchema) ]).optional(),
  icon: z.union([ z.lazy(() => IconSchema),z.lazy(() => EnumIconFieldUpdateOperationsInputSchema) ]).optional(),
...
export const FacilityUncheckedUpdateManyInputSchema: z.ZodType<Prisma.FacilityUncheckedUpdateManyInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  category: z.union([ z.lazy(() => CategorySchema),z.lazy(() => EnumCategoryFieldUpdateOperationsInputSchema) ]).optional(),
  icon: z.union([ z.lazy(() => IconSchema),z.lazy(() => EnumIconFieldUpdateOperationsInputSchema) ]).optional(),
...
export const PasswordRelationFilterSchema: z.ZodType<Prisma.PasswordRelationFilter> = z.object({
...
export const ChatRelationFilterSchema: z.ZodType<Prisma.ChatRelationFilter> = z.object({
  is: z.lazy(() => ChatWhereInputSchema).optional().nullable(),
  isNot: z.lazy(() => ChatWhereInputSchema).optional().nullable()
}).strict();
...
export const FacilityListRelationFilterSchema: z.ZodType<Prisma.FacilityListRelationFilter> = z.object({
...
export const FacilityOrderByRelationAggregateInputSchema: z.ZodType<Prisma.FacilityOrderByRelationAggregateInput> = z.object({
  _count: z.lazy(() => SortOrderSchema).optional()
}).strict();
...
export const EnumCategoryFilterSchema: z.ZodType<Prisma.EnumCategoryFilter> = z.object({
  ...
  in: z.union([ z.lazy(() => CategorySchema).array(),z.lazy(() => CategorySchema) ]).optional(),
  notIn: z.union([ z.lazy(() => CategorySchema).array(),z.lazy(() => CategorySchema) ]).optional(),
  not: z.union([ z.lazy(() => CategorySchema),z.lazy(() => NestedEnumCategoryFilterSchema) ]).optional(),
}).strict();

export const EnumIconFilterSchema: z.ZodType<Prisma.EnumIconFilter> = z.object({
  equals: z.lazy(() => IconSchema).optional(),
  in: z.union([ z.lazy(() => IconSchema).array(),z.lazy(() => IconSchema) ]).optional(),
  notIn: z.union([ z.lazy(() => IconSchema).array(),z.lazy(() => IconSchema) ]).optional(),
  not: z.union([ z.lazy(() => IconSchema),z.lazy(() => NestedEnumIconFilterSchema) ]).optional(),
}).strict();

export const FacilityCountOrderByAggregateInputSchema: z.ZodType<Prisma.FacilityCountOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  description: z.lazy(() => SortOrderSchema).optional(),
  category: z.lazy(() => SortOrderSchema).optional(),
  icon: z.lazy(() => SortOrderSchema).optional()
...
export const FacilityMaxOrderByAggregateInputSchema: z.ZodType<Prisma.FacilityMaxOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  description: z.lazy(() => SortOrderSchema).optional(),
  category: z.lazy(() => SortOrderSchema).optional(),
  icon: z.lazy(() => SortOrderSchema).optional()
...
export const FacilityMinOrderByAggregateInputSchema: z.ZodType<Prisma.FacilityMinOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  description: z.lazy(() => SortOrderSchema).optional(),
  category: z.lazy(() => SortOrderSchema).optional(),
  icon: z.lazy(() => SortOrderSchema).optional()
...
export const EnumIconWithAggregatesFilterSchema: z.ZodType<Prisma.EnumIconWithAggregatesFilter> = z.object({
  equals: z.lazy(() => IconSchema).optional(),
  in: z.union([ z.lazy(() => IconSchema).array(),z.lazy(() => IconSchema) ]).optional(),
  notIn: z.union([ z.lazy(() => IconSchema).array(),z.lazy(() => IconSchema) ]).optional(),
  not: z.union([ z.lazy(() => IconSchema),z.lazy(() => NestedEnumIconWithAggregatesFilterSchema) ]).optional(),
  _count: z.lazy(() => NestedIntFilterSchema).optional(),
...
export const ReservationCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.ReservationCreateNestedManyWithoutUserInput> = z.object({
  create: z.union([ z.lazy(() => ReservationCreateWithoutUserInputSchema),z.lazy(() => ReservationCreateWithoutUserInputSchema).array(),z.lazy(() => ReservationUncheckedCreateWithoutUserInputSchema),z.lazy(() => ReservationUncheckedCreateWithoutUserInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ReservationCreateOrConnectWithoutUserInputSchema),z.lazy(() => ReservationCreateOrConnectWithoutUserInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ReservationCreateManyUserInputEnvelopeSchema).optional(),
...
export const ChatCreateNestedManyWithoutParticipantsInputSchema: z.ZodType<Prisma.ChatCreateNestedManyWithoutParticipantsInput> = z.object({
  create: z.union([ z.lazy(() => ChatCreateWithoutParticipantsInputSchema),z.lazy(() => ChatCreateWithoutParticipantsInputSchema).array(),z.lazy(() => ChatUncheckedCreateWithoutParticipantsInputSchema),z.lazy(() => ChatUncheckedCreateWithoutParticipantsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ChatCreateOrConnectWithoutParticipantsInputSchema),z.lazy(() => ChatCreateOrConnectWithoutParticipantsInputSchema).array() ]).optional(),
...
export const ReservationUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.ReservationUncheckedCreateNestedManyWithoutUserInput> = z.object({
  create: z.union([ z.lazy(() => ReservationCreateWithoutUserInputSchema),z.lazy(() => ReservationCreateWithoutUserInputSchema).array(),z.lazy(() => ReservationUncheckedCreateWithoutUserInputSchema),z.lazy(() => ReservationUncheckedCreateWithoutUserInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ReservationCreateOrConnectWithoutUserInputSchema),z.lazy(() => ReservationCreateOrConnectWithoutUserInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ReservationCreateManyUserInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => ReservationWhereUniqueInputSchema),z.lazy(() => ReservationWhereUniqueInputSchema).array() ]).optional(),
...
export const ChatUncheckedCreateNestedManyWithoutParticipantsInputSchema: z.ZodType<Prisma.ChatUncheckedCreateNestedManyWithoutParticipantsInput> = z.object({
  create: z.union([ z.lazy(() => ChatCreateWithoutParticipantsInputSchema),z.lazy(() => ChatCreateWithoutParticipantsInputSchema).array(),z.lazy(() => ChatUncheckedCreateWithoutParticipantsInputSchema),z.lazy(() => ChatUncheckedCreateWithoutParticipantsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ChatCreateOrConnectWithoutParticipantsInputSchema),z.lazy(() => ChatCreateOrConnectWithoutParticipantsInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => ChatWhereUniqueInputSchema),z.lazy(() => ChatWhereUniqueInputSchema).array() ]).optional(),
}).strict();
...
export const PasswordUpdateOneWithoutUserNestedInputSchema: z.ZodType<Prisma.PasswordUpdateOneWithoutUserNestedInput> = z.object({
  ...
  connect: z.lazy(() => PasswordWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => PasswordUpdateWithoutUserInputSchema),z.lazy(() => PasswordUncheckedUpdateWithoutUserInputSchema) ]).optional(),
}).strict();

export const ReservationUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.ReservationUpdateManyWithoutUserNestedInput> = z.object({
  create: z.union([ z.lazy(() => ReservationCreateWithoutUserInputSchema),z.lazy(() => ReservationCreateWithoutUserInputSchema).array(),z.lazy(() => ReservationUncheckedCreateWithoutUserInputSchema),z.lazy(() => ReservationUncheckedCreateWithoutUserInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ReservationCreateOrConnectWithoutUserInputSchema),z.lazy(() => ReservationCreateOrConnectWithoutUserInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ReservationUpsertWithWhereUniqueWithoutUserInputSchema),z.lazy(() => ReservationUpsertWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ReservationCreateManyUserInputEnvelopeSchema).optional(),
  ...
  connect: z.union([ z.lazy(() => ReservationWhereUniqueInputSchema),z.lazy(() => ReservationWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => ReservationUpdateWithWhereUniqueWithoutUserInputSchema),z.lazy(() => ReservationUpdateWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ReservationUpdateManyWithWhereWithoutUserInputSchema),z.lazy(() => ReservationUpdateManyWithWhereWithoutUserInputSchema).array() ]).optional(),
...
export const ChatUpdateManyWithoutParticipantsNestedInputSchema: z.ZodType<Prisma.ChatUpdateManyWithoutParticipantsNestedInput> = z.object({
  create: z.union([ z.lazy(() => ChatCreateWithoutParticipantsInputSchema),z.lazy(() => ChatCreateWithoutParticipantsInputSchema).array(),z.lazy(() => ChatUncheckedCreateWithoutParticipantsInputSchema),z.lazy(() => ChatUncheckedCreateWithoutParticipantsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ChatCreateOrConnectWithoutParticipantsInputSchema),z.lazy(() => ChatCreateOrConnectWithoutParticipantsInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ChatUpsertWithWhereUniqueWithoutParticipantsInputSchema),z.lazy(() => ChatUpsertWithWhereUniqueWithoutParticipantsInputSchema).array() ]).optional(),
  ...
  connect: z.union([ z.lazy(() => ChatWhereUniqueInputSchema),z.lazy(() => ChatWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => ChatUpdateWithWhereUniqueWithoutParticipantsInputSchema),z.lazy(() => ChatUpdateWithWhereUniqueWithoutParticipantsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ChatUpdateManyWithWhereWithoutParticipantsInputSchema),z.lazy(() => ChatUpdateManyWithWhereWithoutParticipantsInputSchema).array() ]).optional(),
...
export const ReservationUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.ReservationUncheckedUpdateManyWithoutUserNestedInput> = z.object({
  create: z.union([ z.lazy(() => ReservationCreateWithoutUserInputSchema),z.lazy(() => ReservationCreateWithoutUserInputSchema).array(),z.lazy(() => ReservationUncheckedCreateWithoutUserInputSchema),z.lazy(() => ReservationUncheckedCreateWithoutUserInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ReservationCreateOrConnectWithoutUserInputSchema),z.lazy(() => ReservationCreateOrConnectWithoutUserInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ReservationUpsertWithWhereUniqueWithoutUserInputSchema),z.lazy(() => ReservationUpsertWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ReservationCreateManyUserInputEnvelopeSchema).optional(),
...
export const ChatUncheckedUpdateManyWithoutParticipantsNestedInputSchema: z.ZodType<Prisma.ChatUncheckedUpdateManyWithoutParticipantsNestedInput> = z.object({
  create: z.union([ z.lazy(() => ChatCreateWithoutParticipantsInputSchema),z.lazy(() => ChatCreateWithoutParticipantsInputSchema).array(),z.lazy(() => ChatUncheckedCreateWithoutParticipantsInputSchema),z.lazy(() => ChatUncheckedCreateWithoutParticipantsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ChatCreateOrConnectWithoutParticipantsInputSchema),z.lazy(() => ChatCreateOrConnectWithoutParticipantsInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ChatUpsertWithWhereUniqueWithoutParticipantsInputSchema),z.lazy(() => ChatUpsertWithWhereUniqueWithoutParticipantsInputSchema).array() ]).optional(),
  set: z.union([ z.lazy(() => ChatWhereUniqueInputSchema),z.lazy(() => ChatWhereUniqueInputSchema).array() ]).optional(),
...
export const UserUpdateOneRequiredWithoutPasswordNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutPasswordNestedInput> = z.object({
  ...
  connect: z.lazy(() => UserWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => UserUpdateWithoutPasswordInputSchema),z.lazy(() => UserUncheckedUpdateWithoutPasswordInputSchema) ]).optional(),
}).strict();
...
export const UserCreateNestedManyWithoutChatInputSchema: z.ZodType<Prisma.UserCreateNestedManyWithoutChatInput> = z.object({
  create: z.union([ z.lazy(() => UserCreateWithoutChatInputSchema),z.lazy(() => UserCreateWithoutChatInputSchema).array(),z.lazy(() => UserUncheckedCreateWithoutChatInputSchema),z.lazy(() => UserUncheckedCreateWithoutChatInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => UserCreateOrConnectWithoutChatInputSchema),z.lazy(() => UserCreateOrConnectWithoutChatInputSchema).array() ]).optional(),
...
export const UserUncheckedCreateNestedManyWithoutChatInputSchema: z.ZodType<Prisma.UserUncheckedCreateNestedManyWithoutChatInput> = z.object({
  create: z.union([ z.lazy(() => UserCreateWithoutChatInputSchema),z.lazy(() => UserCreateWithoutChatInputSchema).array(),z.lazy(() => UserUncheckedCreateWithoutChatInputSchema),z.lazy(() => UserUncheckedCreateWithoutChatInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => UserCreateOrConnectWithoutChatInputSchema),z.lazy(() => UserCreateOrConnectWithoutChatInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => UserWhereUniqueInputSchema),z.lazy(() => UserWhereUniqueInputSchema).array() ]).optional(),
}).strict();
...
export const UserUpdateManyWithoutChatNestedInputSchema: z.ZodType<Prisma.UserUpdateManyWithoutChatNestedInput> = z.object({
  create: z.union([ z.lazy(() => UserCreateWithoutChatInputSchema),z.lazy(() => UserCreateWithoutChatInputSchema).array(),z.lazy(() => UserUncheckedCreateWithoutChatInputSchema),z.lazy(() => UserUncheckedCreateWithoutChatInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => UserCreateOrConnectWithoutChatInputSchema),z.lazy(() => UserCreateOrConnectWithoutChatInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => UserUpsertWithWhereUniqueWithoutChatInputSchema),z.lazy(() => UserUpsertWithWhereUniqueWithoutChatInputSchema).array() ]).optional(),
  set: z.union([ z.lazy(() => UserWhereUniqueInputSchema),z.lazy(() => UserWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => UserWhereUniqueInputSchema),z.lazy(() => UserWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => UserWhereUniqueInputSchema),z.lazy(() => UserWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => UserWhereUniqueInputSchema),z.lazy(() => UserWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => UserUpdateWithWhereUniqueWithoutChatInputSchema),z.lazy(() => UserUpdateWithWhereUniqueWithoutChatInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => UserUpdateManyWithWhereWithoutChatInputSchema),z.lazy(() => UserUpdateManyWithWhereWithoutChatInputSchema).array() ]).optional(),
...
export const UserUncheckedUpdateManyWithoutChatNestedInputSchema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutChatNestedInput> = z.object({
  create: z.union([ z.lazy(() => UserCreateWithoutChatInputSchema),z.lazy(() => UserCreateWithoutChatInputSchema).array(),z.lazy(() => UserUncheckedCreateWithoutChatInputSchema),z.lazy(() => UserUncheckedCreateWithoutChatInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => UserCreateOrConnectWithoutChatInputSchema),z.lazy(() => UserCreateOrConnectWithoutChatInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => UserUpsertWithWhereUniqueWithoutChatInputSchema),z.lazy(() => UserUpsertWithWhereUniqueWithoutChatInputSchema).array() ]).optional(),
  set: z.union([ z.lazy(() => UserWhereUniqueInputSchema),z.lazy(() => UserWhereUniqueInputSchema).array() ]).optional(),
...
export const PropertyUpdateOneRequiredWithoutReviewsNestedInputSchema: z.ZodType<Prisma.PropertyUpdateOneRequiredWithoutReviewsNestedInput> = z.object({
  ...
  connect: z.lazy(() => PropertyWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => PropertyUpdateWithoutReviewsInputSchema),z.lazy(() => PropertyUncheckedUpdateWithoutReviewsInputSchema) ]).optional(),
}).strict();
...
export const UserCreateNestedOneWithoutReservationsInputSchema: z.ZodType<Prisma.UserCreateNestedOneWithoutReservationsInput> = z.object({
  create: z.union([ z.lazy(() => UserCreateWithoutReservationsInputSchema),z.lazy(() => UserUncheckedCreateWithoutReservationsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => UserCreateOrConnectWithoutReservationsInputSchema).optional(),
  connect: z.lazy(() => UserWhereUniqueInputSchema).optional()
}).strict();
...
export const RoomUpdateOneRequiredWithoutReservationsNestedInputSchema: z.ZodType<Prisma.RoomUpdateOneRequiredWithoutReservationsNestedInput> = z.object({
  create: z.union([ z.lazy(() => RoomCreateWithoutReservationsInputSchema),z.lazy(() => RoomUncheckedCreateWithoutReservationsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => RoomCreateOrConnectWithoutReservationsInputSchema).optional(),
...
export const UserUpdateOneRequiredWithoutReservationsNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutReservationsNestedInput> = z.object({
  create: z.union([ z.lazy(() => UserCreateWithoutReservationsInputSchema),z.lazy(() => UserUncheckedCreateWithoutReservationsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => UserCreateOrConnectWithoutReservationsInputSchema).optional(),
  upsert: z.lazy(() => UserUpsertWithoutReservationsInputSchema).optional(),
  connect: z.lazy(() => UserWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => UserUpdateWithoutReservationsInputSchema),z.lazy(() => UserUncheckedUpdateWithoutReservationsInputSchema) ]).optional(),
}).strict();
...
export const RoomCreateNestedManyWithoutHotelInputSchema: z.ZodType<Prisma.RoomCreateNestedManyWithoutHotelInput> = z.object({
  create: z.union([ z.lazy(() => RoomCreateWithoutHotelInputSchema),z.lazy(() => RoomCreateWithoutHotelInputSchema).array(),z.lazy(() => RoomUncheckedCreateWithoutHotelInputSchema),z.lazy(() => RoomUncheckedCreateWithoutHotelInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => RoomCreateOrConnectWithoutHotelInputSchema),z.lazy(() => RoomCreateOrConnectWithoutHotelInputSchema).array() ]).optional(),
  createMany: z.lazy(() => RoomCreateManyHotelInputEnvelopeSchema).optional(),
...
export const RoomUncheckedCreateNestedManyWithoutHotelInputSchema: z.ZodType<Prisma.RoomUncheckedCreateNestedManyWithoutHotelInput> = z.object({
  create: z.union([ z.lazy(() => RoomCreateWithoutHotelInputSchema),z.lazy(() => RoomCreateWithoutHotelInputSchema).array(),z.lazy(() => RoomUncheckedCreateWithoutHotelInputSchema),z.lazy(() => RoomUncheckedCreateWithoutHotelInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => RoomCreateOrConnectWithoutHotelInputSchema),z.lazy(() => RoomCreateOrConnectWithoutHotelInputSchema).array() ]).optional(),
  createMany: z.lazy(() => RoomCreateManyHotelInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => RoomWhereUniqueInputSchema),z.lazy(() => RoomWhereUniqueInputSchema).array() ]).optional(),
...
export const UserUpdateOneRequiredWithoutPropertiesNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutPropertiesNestedInput> = z.object({
  ...
  connect: z.lazy(() => UserWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => UserUpdateWithoutPropertiesInputSchema),z.lazy(() => UserUncheckedUpdateWithoutPropertiesInputSchema) ]).optional(),
}).strict();

export const RoomUpdateManyWithoutHotelNestedInputSchema: z.ZodType<Prisma.RoomUpdateManyWithoutHotelNestedInput> = z.object({
  create: z.union([ z.lazy(() => RoomCreateWithoutHotelInputSchema),z.lazy(() => RoomCreateWithoutHotelInputSchema).array(),z.lazy(() => RoomUncheckedCreateWithoutHotelInputSchema),z.lazy(() => RoomUncheckedCreateWithoutHotelInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => RoomCreateOrConnectWithoutHotelInputSchema),z.lazy(() => RoomCreateOrConnectWithoutHotelInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => RoomUpsertWithWhereUniqueWithoutHotelInputSchema),z.lazy(() => RoomUpsertWithWhereUniqueWithoutHotelInputSchema).array() ]).optional(),
  createMany: z.lazy(() => RoomCreateManyHotelInputEnvelopeSchema).optional(),
  ...
  connect: z.union([ z.lazy(() => RoomWhereUniqueInputSchema),z.lazy(() => RoomWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => RoomUpdateWithWhereUniqueWithoutHotelInputSchema),z.lazy(() => RoomUpdateWithWhereUniqueWithoutHotelInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => RoomUpdateManyWithWhereWithoutHotelInputSchema),z.lazy(() => RoomUpdateManyWithWhereWithoutHotelInputSchema).array() ]).optional(),
...
export const RoomUncheckedUpdateManyWithoutHotelNestedInputSchema: z.ZodType<Prisma.RoomUncheckedUpdateManyWithoutHotelNestedInput> = z.object({
  create: z.union([ z.lazy(() => RoomCreateWithoutHotelInputSchema),z.lazy(() => RoomCreateWithoutHotelInputSchema).array(),z.lazy(() => RoomUncheckedCreateWithoutHotelInputSchema),z.lazy(() => RoomUncheckedCreateWithoutHotelInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => RoomCreateOrConnectWithoutHotelInputSchema),z.lazy(() => RoomCreateOrConnectWithoutHotelInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => RoomUpsertWithWhereUniqueWithoutHotelInputSchema),z.lazy(() => RoomUpsertWithWhereUniqueWithoutHotelInputSchema).array() ]).optional(),
  createMany: z.lazy(() => RoomCreateManyHotelInputEnvelopeSchema).optional(),
...
export const PropertyCreateNestedOneWithoutRoomsInputSchema: z.ZodType<Prisma.PropertyCreateNestedOneWithoutRoomsInput> = z.object({
  create: z.union([ z.lazy(() => PropertyCreateWithoutRoomsInputSchema),z.lazy(() => PropertyUncheckedCreateWithoutRoomsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => PropertyCreateOrConnectWithoutRoomsInputSchema).optional(),
  connect: z.lazy(() => PropertyWhereUniqueInputSchema).optional()
}).strict();
...
export const FacilityCreateNestedManyWithoutRoomsInputSchema: z.ZodType<Prisma.FacilityCreateNestedManyWithoutRoomsInput> = z.object({
  create: z.union([ z.lazy(() => FacilityCreateWithoutRoomsInputSchema),z.lazy(() => FacilityCreateWithoutRoomsInputSchema).array(),z.lazy(() => FacilityUncheckedCreateWithoutRoomsInputSchema),z.lazy(() => FacilityUncheckedCreateWithoutRoomsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => FacilityCreateOrConnectWithoutRoomsInputSchema),z.lazy(() => FacilityCreateOrConnectWithoutRoomsInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => FacilityWhereUniqueInputSchema),z.lazy(() => FacilityWhereUniqueInputSchema).array() ]).optional(),
}).strict();
...
export const FacilityUncheckedCreateNestedManyWithoutRoomsInputSchema: z.ZodType<Prisma.FacilityUncheckedCreateNestedManyWithoutRoomsInput> = z.object({
  create: z.union([ z.lazy(() => FacilityCreateWithoutRoomsInputSchema),z.lazy(() => FacilityCreateWithoutRoomsInputSchema).array(),z.lazy(() => FacilityUncheckedCreateWithoutRoomsInputSchema),z.lazy(() => FacilityUncheckedCreateWithoutRoomsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => FacilityCreateOrConnectWithoutRoomsInputSchema),z.lazy(() => FacilityCreateOrConnectWithoutRoomsInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => FacilityWhereUniqueInputSchema),z.lazy(() => FacilityWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const PropertyUpdateOneRequiredWithoutRoomsNestedInputSchema: z.ZodType<Prisma.PropertyUpdateOneRequiredWithoutRoomsNestedInput> = z.object({
  create: z.union([ z.lazy(() => PropertyCreateWithoutRoomsInputSchema),z.lazy(() => PropertyUncheckedCreateWithoutRoomsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => PropertyCreateOrConnectWithoutRoomsInputSchema).optional(),
  upsert: z.lazy(() => PropertyUpsertWithoutRoomsInputSchema).optional(),
  connect: z.lazy(() => PropertyWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => PropertyUpdateWithoutRoomsInputSchema),z.lazy(() => PropertyUncheckedUpdateWithoutRoomsInputSchema) ]).optional(),
}).strict();
...
export const FacilityUpdateManyWithoutRoomsNestedInputSchema: z.ZodType<Prisma.FacilityUpdateManyWithoutRoomsNestedInput> = z.object({
  create: z.union([ z.lazy(() => FacilityCreateWithoutRoomsInputSchema),z.lazy(() => FacilityCreateWithoutRoomsInputSchema).array(),z.lazy(() => FacilityUncheckedCreateWithoutRoomsInputSchema),z.lazy(() => FacilityUncheckedCreateWithoutRoomsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => FacilityCreateOrConnectWithoutRoomsInputSchema),z.lazy(() => FacilityCreateOrConnectWithoutRoomsInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => FacilityUpsertWithWhereUniqueWithoutRoomsInputSchema),z.lazy(() => FacilityUpsertWithWhereUniqueWithoutRoomsInputSchema).array() ]).optional(),
  set: z.union([ z.lazy(() => FacilityWhereUniqueInputSchema),z.lazy(() => FacilityWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => FacilityWhereUniqueInputSchema),z.lazy(() => FacilityWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => FacilityWhereUniqueInputSchema),z.lazy(() => FacilityWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => FacilityWhereUniqueInputSchema),z.lazy(() => FacilityWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => FacilityUpdateWithWhereUniqueWithoutRoomsInputSchema),z.lazy(() => FacilityUpdateWithWhereUniqueWithoutRoomsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => FacilityUpdateManyWithWhereWithoutRoomsInputSchema),z.lazy(() => FacilityUpdateManyWithWhereWithoutRoomsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => FacilityScalarWhereInputSchema),z.lazy(() => FacilityScalarWhereInputSchema).array() ]).optional(),
}).strict();
...
export const FacilityUncheckedUpdateManyWithoutRoomsNestedInputSchema: z.ZodType<Prisma.FacilityUncheckedUpdateManyWithoutRoomsNestedInput> = z.object({
  create: z.union([ z.lazy(() => FacilityCreateWithoutRoomsInputSchema),z.lazy(() => FacilityCreateWithoutRoomsInputSchema).array(),z.lazy(() => FacilityUncheckedCreateWithoutRoomsInputSchema),z.lazy(() => FacilityUncheckedCreateWithoutRoomsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => FacilityCreateOrConnectWithoutRoomsInputSchema),z.lazy(() => FacilityCreateOrConnectWithoutRoomsInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => FacilityUpsertWithWhereUniqueWithoutRoomsInputSchema),z.lazy(() => FacilityUpsertWithWhereUniqueWithoutRoomsInputSchema).array() ]).optional(),
  set: z.union([ z.lazy(() => FacilityWhereUniqueInputSchema),z.lazy(() => FacilityWhereUniqueInputSchema).array() ]).optional(),
...
export const RoomCreateNestedManyWithoutFacilitiesInputSchema: z.ZodType<Prisma.RoomCreateNestedManyWithoutFacilitiesInput> = z.object({
  create: z.union([ z.lazy(() => RoomCreateWithoutFacilitiesInputSchema),z.lazy(() => RoomCreateWithoutFacilitiesInputSchema).array(),z.lazy(() => RoomUncheckedCreateWithoutFacilitiesInputSchema),z.lazy(() => RoomUncheckedCreateWithoutFacilitiesInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => RoomCreateOrConnectWithoutFacilitiesInputSchema),z.lazy(() => RoomCreateOrConnectWithoutFacilitiesInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => RoomWhereUniqueInputSchema),z.lazy(() => RoomWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const RoomUncheckedCreateNestedManyWithoutFacilitiesInputSchema: z.ZodType<Prisma.RoomUncheckedCreateNestedManyWithoutFacilitiesInput> = z.object({
  create: z.union([ z.lazy(() => RoomCreateWithoutFacilitiesInputSchema),z.lazy(() => RoomCreateWithoutFacilitiesInputSchema).array(),z.lazy(() => RoomUncheckedCreateWithoutFacilitiesInputSchema),z.lazy(() => RoomUncheckedCreateWithoutFacilitiesInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => RoomCreateOrConnectWithoutFacilitiesInputSchema),z.lazy(() => RoomCreateOrConnectWithoutFacilitiesInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => RoomWhereUniqueInputSchema),z.lazy(() => RoomWhereUniqueInputSchema).array() ]).optional(),
}).strict();
...
export const EnumIconFieldUpdateOperationsInputSchema: z.ZodType<Prisma.EnumIconFieldUpdateOperationsInput> = z.object({
  set: z.lazy(() => IconSchema).optional()
}).strict();

export const RoomUpdateManyWithoutFacilitiesNestedInputSchema: z.ZodType<Prisma.RoomUpdateManyWithoutFacilitiesNestedInput> = z.object({
  create: z.union([ z.lazy(() => RoomCreateWithoutFacilitiesInputSchema),z.lazy(() => RoomCreateWithoutFacilitiesInputSchema).array(),z.lazy(() => RoomUncheckedCreateWithoutFacilitiesInputSchema),z.lazy(() => RoomUncheckedCreateWithoutFacilitiesInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => RoomCreateOrConnectWithoutFacilitiesInputSchema),z.lazy(() => RoomCreateOrConnectWithoutFacilitiesInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => RoomUpsertWithWhereUniqueWithoutFacilitiesInputSchema),z.lazy(() => RoomUpsertWithWhereUniqueWithoutFacilitiesInputSchema).array() ]).optional(),
  set: z.union([ z.lazy(() => RoomWhereUniqueInputSchema),z.lazy(() => RoomWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => RoomWhereUniqueInputSchema),z.lazy(() => RoomWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => RoomWhereUniqueInputSchema),z.lazy(() => RoomWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => RoomWhereUniqueInputSchema),z.lazy(() => RoomWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => RoomUpdateWithWhereUniqueWithoutFacilitiesInputSchema),z.lazy(() => RoomUpdateWithWhereUniqueWithoutFacilitiesInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => RoomUpdateManyWithWhereWithoutFacilitiesInputSchema),z.lazy(() => RoomUpdateManyWithWhereWithoutFacilitiesInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => RoomScalarWhereInputSchema),z.lazy(() => RoomScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const RoomUncheckedUpdateManyWithoutFacilitiesNestedInputSchema: z.ZodType<Prisma.RoomUncheckedUpdateManyWithoutFacilitiesNestedInput> = z.object({
  create: z.union([ z.lazy(() => RoomCreateWithoutFacilitiesInputSchema),z.lazy(() => RoomCreateWithoutFacilitiesInputSchema).array(),z.lazy(() => RoomUncheckedCreateWithoutFacilitiesInputSchema),z.lazy(() => RoomUncheckedCreateWithoutFacilitiesInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => RoomCreateOrConnectWithoutFacilitiesInputSchema),z.lazy(() => RoomCreateOrConnectWithoutFacilitiesInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => RoomUpsertWithWhereUniqueWithoutFacilitiesInputSchema),z.lazy(() => RoomUpsertWithWhereUniqueWithoutFacilitiesInputSchema).array() ]).optional(),
  set: z.union([ z.lazy(() => RoomWhereUniqueInputSchema),z.lazy(() => RoomWhereUniqueInputSchema).array() ]).optional(),
...
export const NestedEnumIconFilterSchema: z.ZodType<Prisma.NestedEnumIconFilter> = z.object({
  equals: z.lazy(() => IconSchema).optional(),
  in: z.union([ z.lazy(() => IconSchema).array(),z.lazy(() => IconSchema) ]).optional(),
  notIn: z.union([ z.lazy(() => IconSchema).array(),z.lazy(() => IconSchema) ]).optional(),
  not: z.union([ z.lazy(() => IconSchema),z.lazy(() => NestedEnumIconFilterSchema) ]).optional(),
...
export const NestedEnumIconWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumIconWithAggregatesFilter> = z.object({
  equals: z.lazy(() => IconSchema).optional(),
  in: z.union([ z.lazy(() => IconSchema).array(),z.lazy(() => IconSchema) ]).optional(),
  notIn: z.union([ z.lazy(() => IconSchema).array(),z.lazy(() => IconSchema) ]).optional(),
  not: z.union([ z.lazy(() => IconSchema),z.lazy(() => NestedEnumIconWithAggregatesFilterSchema) ]).optional(),
...
export const ReservationCreateWithoutUserInputSchema: z.ZodType<Prisma.ReservationCreateWithoutUserInput> = z.object({
  id: z.string().cuid().optional(),
  price: z.number(),
  from: z.coerce.date(),
  to: z.coerce.date(),
...
export const ReservationUncheckedCreateWithoutUserInputSchema: z.ZodType<Prisma.ReservationUncheckedCreateWithoutUserInput> = z.object({
  id: z.string().cuid().optional(),
  price: z.number(),
  from: z.coerce.date(),
  to: z.coerce.date(),
...
export const ReservationCreateOrConnectWithoutUserInputSchema: z.ZodType<Prisma.ReservationCreateOrConnectWithoutUserInput> = z.object({
  where: z.lazy(() => ReservationWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => ReservationCreateWithoutUserInputSchema),z.lazy(() => ReservationUncheckedCreateWithoutUserInputSchema) ]),
}).strict();

export const ReservationCreateManyUserInputEnvelopeSchema: z.ZodType<Prisma.ReservationCreateManyUserInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => ReservationCreateManyUserInputSchema),z.lazy(() => ReservationCreateManyUserInputSchema).array() ]),
...
export const ChatCreateWithoutParticipantsInputSchema: z.ZodType<Prisma.ChatCreateWithoutParticipantsInput> = z.object({
  id: z.string().cuid().optional(),
  messages: z.lazy(() => MessageCreateNestedManyWithoutChatInputSchema).optional()
}).strict();

export const ChatUncheckedCreateWithoutParticipantsInputSchema: z.ZodType<Prisma.ChatUncheckedCreateWithoutParticipantsInput> = z.object({
  id: z.string().cuid().optional(),
  messages: z.lazy(() => MessageUncheckedCreateNestedManyWithoutChatInputSchema).optional()
}).strict();

export const ChatCreateOrConnectWithoutParticipantsInputSchema: z.ZodType<Prisma.ChatCreateOrConnectWithoutParticipantsInput> = z.object({
  where: z.lazy(() => ChatWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => ChatCreateWithoutParticipantsInputSchema),z.lazy(() => ChatUncheckedCreateWithoutParticipantsInputSchema) ]),
}).strict();
...
export const ReservationUpsertWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.ReservationUpsertWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => ReservationWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ReservationUpdateWithoutUserInputSchema),z.lazy(() => ReservationUncheckedUpdateWithoutUserInputSchema) ]),
  create: z.union([ z.lazy(() => ReservationCreateWithoutUserInputSchema),z.lazy(() => ReservationUncheckedCreateWithoutUserInputSchema) ]),
}).strict();

export const ReservationUpdateWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.ReservationUpdateWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => ReservationWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ReservationUpdateWithoutUserInputSchema),z.lazy(() => ReservationUncheckedUpdateWithoutUserInputSchema) ]),
}).strict();

export const ReservationUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.ReservationUpdateManyWithWhereWithoutUserInput> = z.object({
...
export const ChatUpsertWithWhereUniqueWithoutParticipantsInputSchema: z.ZodType<Prisma.ChatUpsertWithWhereUniqueWithoutParticipantsInput> = z.object({
  where: z.lazy(() => ChatWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ChatUpdateWithoutParticipantsInputSchema),z.lazy(() => ChatUncheckedUpdateWithoutParticipantsInputSchema) ]),
  create: z.union([ z.lazy(() => ChatCreateWithoutParticipantsInputSchema),z.lazy(() => ChatUncheckedCreateWithoutParticipantsInputSchema) ]),
}).strict();

export const ChatUpdateWithWhereUniqueWithoutParticipantsInputSchema: z.ZodType<Prisma.ChatUpdateWithWhereUniqueWithoutParticipantsInput> = z.object({
  where: z.lazy(() => ChatWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ChatUpdateWithoutParticipantsInputSchema),z.lazy(() => ChatUncheckedUpdateWithoutParticipantsInputSchema) ]),
}).strict();

export const ChatUpdateManyWithWhereWithoutParticipantsInputSchema: z.ZodType<Prisma.ChatUpdateManyWithWhereWithoutParticipantsInput> = z.object({
...
export const UserUpsertWithWhereUniqueWithoutChatInputSchema: z.ZodType<Prisma.UserUpsertWithWhereUniqueWithoutChatInput> = z.object({
  where: z.lazy(() => UserWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => UserUpdateWithoutChatInputSchema),z.lazy(() => UserUncheckedUpdateWithoutChatInputSchema) ]),
  create: z.union([ z.lazy(() => UserCreateWithoutChatInputSchema),z.lazy(() => UserUncheckedCreateWithoutChatInputSchema) ]),
}).strict();

export const UserUpdateWithWhereUniqueWithoutChatInputSchema: z.ZodType<Prisma.UserUpdateWithWhereUniqueWithoutChatInput> = z.object({
  where: z.lazy(() => UserWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => UserUpdateWithoutChatInputSchema),z.lazy(() => UserUncheckedUpdateWithoutChatInputSchema) ]),
}).strict();

export const UserUpdateManyWithWhereWithoutChatInputSchema: z.ZodType<Prisma.UserUpdateManyWithWhereWithoutChatInput> = z.object({
  where: z.lazy(() => UserScalarWhereInputSchema),
  data: z.union([ z.lazy(() => UserUpdateManyMutationInputSchema),z.lazy(() => UserUncheckedUpdateManyWithoutParticipantsInputSchema) ]),
}).strict();
...
export const UserCreateWithoutReservationsInputSchema: z.ZodType<Prisma.UserCreateWithoutReservationsInput> = z.object({
  id: z.string().cuid().optional(),
  email: z.string(),
  roles: z.union([ z.lazy(() => UserCreaterolesInputSchema),z.lazy(() => RoleSchema).array() ]).optional(),
  fname: z.string(),
...
export const UserUncheckedCreateWithoutReservationsInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutReservationsInput> = z.object({
  id: z.string().cuid().optional(),
  email: z.string(),
  roles: z.union([ z.lazy(() => UserCreaterolesInputSchema),z.lazy(() => RoleSchema).array() ]).optional(),
  fname: z.string(),
...
export const UserCreateOrConnectWithoutReservationsInputSchema: z.ZodType<Prisma.UserCreateOrConnectWithoutReservationsInput> = z.object({
  where: z.lazy(() => UserWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => UserCreateWithoutReservationsInputSchema),z.lazy(() => UserUncheckedCreateWithoutReservationsInputSchema) ]),
}).strict();
...
export const UserUpsertWithoutReservationsInputSchema: z.ZodType<Prisma.UserUpsertWithoutReservationsInput> = z.object({
  update: z.union([ z.lazy(() => UserUpdateWithoutReservationsInputSchema),z.lazy(() => UserUncheckedUpdateWithoutReservationsInputSchema) ]),
  create: z.union([ z.lazy(() => UserCreateWithoutReservationsInputSchema),z.lazy(() => UserUncheckedCreateWithoutReservationsInputSchema) ]),
}).strict();

export const UserUpdateWithoutReservationsInputSchema: z.ZodType<Prisma.UserUpdateWithoutReservationsInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  email: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  roles: z.union([ z.lazy(() => UserUpdaterolesInputSchema),z.lazy(() => RoleSchema).array() ]).optional(),
  fname: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const UserUncheckedUpdateWithoutReservationsInputSchema: z.ZodType<Prisma.UserUncheckedUpdateWithoutReservationsInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  email: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  roles: z.union([ z.lazy(() => UserUpdaterolesInputSchema),z.lazy(() => RoleSchema).array() ]).optional(),
  fname: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const RoomCreateWithoutHotelInputSchema: z.ZodType<Prisma.RoomCreateWithoutHotelInput> = z.object({
  id: z.string().cuid().optional(),
  quantity: z.number().int(),
  maxGuests: z.number().int(),
  price: z.number(),
...
export const RoomUncheckedCreateWithoutHotelInputSchema: z.ZodType<Prisma.RoomUncheckedCreateWithoutHotelInput> = z.object({
  id: z.string().cuid().optional(),
  quantity: z.number().int(),
  maxGuests: z.number().int(),
  price: z.number(),
...
export const RoomCreateOrConnectWithoutHotelInputSchema: z.ZodType<Prisma.RoomCreateOrConnectWithoutHotelInput> = z.object({
  where: z.lazy(() => RoomWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => RoomCreateWithoutHotelInputSchema),z.lazy(() => RoomUncheckedCreateWithoutHotelInputSchema) ]),
}).strict();

export const RoomCreateManyHotelInputEnvelopeSchema: z.ZodType<Prisma.RoomCreateManyHotelInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => RoomCreateManyHotelInputSchema),z.lazy(() => RoomCreateManyHotelInputSchema).array() ]),
  skipDuplicates: z.boolean().optional()
}).strict();
...
export const RoomUpsertWithWhereUniqueWithoutHotelInputSchema: z.ZodType<Prisma.RoomUpsertWithWhereUniqueWithoutHotelInput> = z.object({
  where: z.lazy(() => RoomWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => RoomUpdateWithoutHotelInputSchema),z.lazy(() => RoomUncheckedUpdateWithoutHotelInputSchema) ]),
  create: z.union([ z.lazy(() => RoomCreateWithoutHotelInputSchema),z.lazy(() => RoomUncheckedCreateWithoutHotelInputSchema) ]),
}).strict();

export const RoomUpdateWithWhereUniqueWithoutHotelInputSchema: z.ZodType<Prisma.RoomUpdateWithWhereUniqueWithoutHotelInput> = z.object({
  where: z.lazy(() => RoomWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => RoomUpdateWithoutHotelInputSchema),z.lazy(() => RoomUncheckedUpdateWithoutHotelInputSchema) ]),
}).strict();

export const RoomUpdateManyWithWhereWithoutHotelInputSchema: z.ZodType<Prisma.RoomUpdateManyWithWhereWithoutHotelInput> = z.object({
...
export const PropertyCreateWithoutRoomsInputSchema: z.ZodType<Prisma.PropertyCreateWithoutRoomsInput> = z.object({
  id: z.string().cuid().optional(),
  description: z.string(),
  owner: z.lazy(() => UserCreateNestedOneWithoutPropertiesInputSchema),
  reviews: z.lazy(() => ReviewCreateNestedManyWithoutPropertyInputSchema).optional()
...
export const PropertyUncheckedCreateWithoutRoomsInputSchema: z.ZodType<Prisma.PropertyUncheckedCreateWithoutRoomsInput> = z.object({
  id: z.string().cuid().optional(),
  description: z.string(),
  ownerId: z.string(),
  reviews: z.lazy(() => ReviewUncheckedCreateNestedManyWithoutPropertyInputSchema).optional()
...
export const PropertyCreateOrConnectWithoutRoomsInputSchema: z.ZodType<Prisma.PropertyCreateOrConnectWithoutRoomsInput> = z.object({
  where: z.lazy(() => PropertyWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => PropertyCreateWithoutRoomsInputSchema),z.lazy(() => PropertyUncheckedCreateWithoutRoomsInputSchema) ]),
}).strict();
...
export const FacilityCreateWithoutRoomsInputSchema: z.ZodType<Prisma.FacilityCreateWithoutRoomsInput> = z.object({
  id: z.string().cuid().optional(),
  description: z.string(),
  category: z.lazy(() => CategorySchema),
  icon: z.lazy(() => IconSchema)
...
export const FacilityUncheckedCreateWithoutRoomsInputSchema: z.ZodType<Prisma.FacilityUncheckedCreateWithoutRoomsInput> = z.object({
  id: z.string().cuid().optional(),
  description: z.string(),
  category: z.lazy(() => CategorySchema),
  icon: z.lazy(() => IconSchema)
...
export const FacilityCreateOrConnectWithoutRoomsInputSchema: z.ZodType<Prisma.FacilityCreateOrConnectWithoutRoomsInput> = z.object({
  where: z.lazy(() => FacilityWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => FacilityCreateWithoutRoomsInputSchema),z.lazy(() => FacilityUncheckedCreateWithoutRoomsInputSchema) ]),
}).strict();

export const PropertyUpsertWithoutRoomsInputSchema: z.ZodType<Prisma.PropertyUpsertWithoutRoomsInput> = z.object({
  update: z.union([ z.lazy(() => PropertyUpdateWithoutRoomsInputSchema),z.lazy(() => PropertyUncheckedUpdateWithoutRoomsInputSchema) ]),
  create: z.union([ z.lazy(() => PropertyCreateWithoutRoomsInputSchema),z.lazy(() => PropertyUncheckedCreateWithoutRoomsInputSchema) ]),
}).strict();

export const PropertyUpdateWithoutRoomsInputSchema: z.ZodType<Prisma.PropertyUpdateWithoutRoomsInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  owner: z.lazy(() => UserUpdateOneRequiredWithoutPropertiesNestedInputSchema).optional(),
  reviews: z.lazy(() => ReviewUpdateManyWithoutPropertyNestedInputSchema).optional()
...
export const PropertyUncheckedUpdateWithoutRoomsInputSchema: z.ZodType<Prisma.PropertyUncheckedUpdateWithoutRoomsInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  ownerId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  reviews: z.lazy(() => ReviewUncheckedUpdateManyWithoutPropertyNestedInputSchema).optional()
...
export const FacilityUpsertWithWhereUniqueWithoutRoomsInputSchema: z.ZodType<Prisma.FacilityUpsertWithWhereUniqueWithoutRoomsInput> = z.object({
  where: z.lazy(() => FacilityWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => FacilityUpdateWithoutRoomsInputSchema),z.lazy(() => FacilityUncheckedUpdateWithoutRoomsInputSchema) ]),
  create: z.union([ z.lazy(() => FacilityCreateWithoutRoomsInputSchema),z.lazy(() => FacilityUncheckedCreateWithoutRoomsInputSchema) ]),
}).strict();

export const FacilityUpdateWithWhereUniqueWithoutRoomsInputSchema: z.ZodType<Prisma.FacilityUpdateWithWhereUniqueWithoutRoomsInput> = z.object({
  where: z.lazy(() => FacilityWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => FacilityUpdateWithoutRoomsInputSchema),z.lazy(() => FacilityUncheckedUpdateWithoutRoomsInputSchema) ]),
}).strict();

export const FacilityUpdateManyWithWhereWithoutRoomsInputSchema: z.ZodType<Prisma.FacilityUpdateManyWithWhereWithoutRoomsInput> = z.object({
  where: z.lazy(() => FacilityScalarWhereInputSchema),
  data: z.union([ z.lazy(() => FacilityUpdateManyMutationInputSchema),z.lazy(() => FacilityUncheckedUpdateManyWithoutFacilitiesInputSchema) ]),
}).strict();

export const FacilityScalarWhereInputSchema: z.ZodType<Prisma.FacilityScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => FacilityScalarWhereInputSchema),z.lazy(() => FacilityScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => FacilityScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => FacilityScalarWhereInputSchema),z.lazy(() => FacilityScalarWhereInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  description: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  category: z.union([ z.lazy(() => EnumCategoryFilterSchema),z.lazy(() => CategorySchema) ]).optional(),
  icon: z.union([ z.lazy(() => EnumIconFilterSchema),z.lazy(() => IconSchema) ]).optional(),
...
export const RoomCreateWithoutFacilitiesInputSchema: z.ZodType<Prisma.RoomCreateWithoutFacilitiesInput> = z.object({
  id: z.string().cuid().optional(),
  quantity: z.number().int(),
  maxGuests: z.number().int(),
  price: z.number(),
...
export const RoomUncheckedCreateWithoutFacilitiesInputSchema: z.ZodType<Prisma.RoomUncheckedCreateWithoutFacilitiesInput> = z.object({
  id: z.string().cuid().optional(),
  quantity: z.number().int(),
  maxGuests: z.number().int(),
  price: z.number(),
...
export const RoomCreateOrConnectWithoutFacilitiesInputSchema: z.ZodType<Prisma.RoomCreateOrConnectWithoutFacilitiesInput> = z.object({
  where: z.lazy(() => RoomWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => RoomCreateWithoutFacilitiesInputSchema),z.lazy(() => RoomUncheckedCreateWithoutFacilitiesInputSchema) ]),
}).strict();

export const RoomUpsertWithWhereUniqueWithoutFacilitiesInputSchema: z.ZodType<Prisma.RoomUpsertWithWhereUniqueWithoutFacilitiesInput> = z.object({
  where: z.lazy(() => RoomWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => RoomUpdateWithoutFacilitiesInputSchema),z.lazy(() => RoomUncheckedUpdateWithoutFacilitiesInputSchema) ]),
  create: z.union([ z.lazy(() => RoomCreateWithoutFacilitiesInputSchema),z.lazy(() => RoomUncheckedCreateWithoutFacilitiesInputSchema) ]),
}).strict();

export const RoomUpdateWithWhereUniqueWithoutFacilitiesInputSchema: z.ZodType<Prisma.RoomUpdateWithWhereUniqueWithoutFacilitiesInput> = z.object({
  where: z.lazy(() => RoomWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => RoomUpdateWithoutFacilitiesInputSchema),z.lazy(() => RoomUncheckedUpdateWithoutFacilitiesInputSchema) ]),
}).strict();

export const RoomUpdateManyWithWhereWithoutFacilitiesInputSchema: z.ZodType<Prisma.RoomUpdateManyWithWhereWithoutFacilitiesInput> = z.object({
  where: z.lazy(() => RoomScalarWhereInputSchema),
  data: z.union([ z.lazy(() => RoomUpdateManyMutationInputSchema),z.lazy(() => RoomUncheckedUpdateManyWithoutRoomsInputSchema) ]),
}).strict();

export const ReservationCreateManyUserInputSchema: z.ZodType<Prisma.ReservationCreateManyUserInput> = z.object({
  id: z.string().cuid().optional(),
  price: z.number(),
  from: z.coerce.date(),
  to: z.coerce.date(),
...
export const ReservationUpdateWithoutUserInputSchema: z.ZodType<Prisma.ReservationUpdateWithoutUserInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  price: z.union([ z.number(),z.lazy(() => FloatFieldUpdateOperationsInputSchema) ]).optional(),
  from: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  to: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ReservationUncheckedUpdateWithoutUserInputSchema: z.ZodType<Prisma.ReservationUncheckedUpdateWithoutUserInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  price: z.union([ z.number(),z.lazy(() => FloatFieldUpdateOperationsInputSchema) ]).optional(),
  from: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  to: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ChatUpdateWithoutParticipantsInputSchema: z.ZodType<Prisma.ChatUpdateWithoutParticipantsInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  messages: z.lazy(() => MessageUpdateManyWithoutChatNestedInputSchema).optional()
}).strict();

export const ChatUncheckedUpdateWithoutParticipantsInputSchema: z.ZodType<Prisma.ChatUncheckedUpdateWithoutParticipantsInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  messages: z.lazy(() => MessageUncheckedUpdateManyWithoutChatNestedInputSchema).optional()
}).strict();
...
export const UserUncheckedUpdateManyWithoutParticipantsInputSchema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutParticipantsInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  email: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  roles: z.union([ z.lazy(() => UserUpdaterolesInputSchema),z.lazy(() => RoleSchema).array() ]).optional(),
  fname: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const RoomCreateManyHotelInputSchema: z.ZodType<Prisma.RoomCreateManyHotelInput> = z.object({
  id: z.string().cuid().optional(),
  quantity: z.number().int(),
  maxGuests: z.number().int(),
  price: z.number()
...
export const RoomUpdateWithoutHotelInputSchema: z.ZodType<Prisma.RoomUpdateWithoutHotelInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  quantity: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  maxGuests: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  price: z.union([ z.number(),z.lazy(() => FloatFieldUpdateOperationsInputSchema) ]).optional(),
...
export const RoomUncheckedUpdateWithoutHotelInputSchema: z.ZodType<Prisma.RoomUncheckedUpdateWithoutHotelInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  quantity: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  maxGuests: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  price: z.union([ z.number(),z.lazy(() => FloatFieldUpdateOperationsInputSchema) ]).optional(),
...
export const FacilityUpdateWithoutRoomsInputSchema: z.ZodType<Prisma.FacilityUpdateWithoutRoomsInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  category: z.union([ z.lazy(() => CategorySchema),z.lazy(() => EnumCategoryFieldUpdateOperationsInputSchema) ]).optional(),
  icon: z.union([ z.lazy(() => IconSchema),z.lazy(() => EnumIconFieldUpdateOperationsInputSchema) ]).optional(),
...
export const FacilityUncheckedUpdateWithoutRoomsInputSchema: z.ZodType<Prisma.FacilityUncheckedUpdateWithoutRoomsInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  category: z.union([ z.lazy(() => CategorySchema),z.lazy(() => EnumCategoryFieldUpdateOperationsInputSchema) ]).optional(),
  icon: z.union([ z.lazy(() => IconSchema),z.lazy(() => EnumIconFieldUpdateOperationsInputSchema) ]).optional(),
...
export const FacilityUncheckedUpdateManyWithoutFacilitiesInputSchema: z.ZodType<Prisma.FacilityUncheckedUpdateManyWithoutFacilitiesInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  category: z.union([ z.lazy(() => CategorySchema),z.lazy(() => EnumCategoryFieldUpdateOperationsInputSchema) ]).optional(),
  icon: z.union([ z.lazy(() => IconSchema),z.lazy(() => EnumIconFieldUpdateOperationsInputSchema) ]).optional(),
...
export const RoomUpdateWithoutFacilitiesInputSchema: z.ZodType<Prisma.RoomUpdateWithoutFacilitiesInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  quantity: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  maxGuests: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  price: z.union([ z.number(),z.lazy(() => FloatFieldUpdateOperationsInputSchema) ]).optional(),
...
export const RoomUncheckedUpdateWithoutFacilitiesInputSchema: z.ZodType<Prisma.RoomUncheckedUpdateWithoutFacilitiesInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  quantity: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  maxGuests: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  price: z.union([ z.number(),z.lazy(() => FloatFieldUpdateOperationsInputSchema) ]).optional(),
...
export const FacilityFindFirstArgsSchema: z.ZodType<Prisma.FacilityFindFirstArgs> = z.object({
  select: FacilitySelectSchema.optional(),
  include: FacilityIncludeSchema.optional(),
  where: FacilityWhereInputSchema.optional(),
  orderBy: z.union([ FacilityOrderByWithRelationInputSchema.array(),FacilityOrderByWithRelationInputSchema ]).optional(),
  cursor: FacilityWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ FacilityScalarFieldEnumSchema,FacilityScalarFieldEnumSchema.array() ]).optional(),
}).strict()

export const FacilityFindFirstOrThrowArgsSchema: z.ZodType<Prisma.FacilityFindFirstOrThrowArgs> = z.object({
  select: FacilitySelectSchema.optional(),
  include: FacilityIncludeSchema.optional(),
  where: FacilityWhereInputSchema.optional(),
  orderBy: z.union([ FacilityOrderByWithRelationInputSchema.array(),FacilityOrderByWithRelationInputSchema ]).optional(),
...
export const FacilityFindManyArgsSchema: z.ZodType<Prisma.FacilityFindManyArgs> = z.object({
  select: FacilitySelectSchema.optional(),
  include: FacilityIncludeSchema.optional(),
  where: FacilityWhereInputSchema.optional(),
  orderBy: z.union([ FacilityOrderByWithRelationInputSchema.array(),FacilityOrderByWithRelationInputSchema ]).optional(),
...
export const FacilityAggregateArgsSchema: z.ZodType<Prisma.FacilityAggregateArgs> = z.object({
  where: FacilityWhereInputSchema.optional(),
  orderBy: z.union([ FacilityOrderByWithRelationInputSchema.array(),FacilityOrderByWithRelationInputSchema ]).optional(),
  cursor: FacilityWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
...
export const FacilityGroupByArgsSchema: z.ZodType<Prisma.FacilityGroupByArgs> = z.object({
  where: FacilityWhereInputSchema.optional(),
  orderBy: z.union([ FacilityOrderByWithAggregationInputSchema.array(),FacilityOrderByWithAggregationInputSchema ]).optional(),
...
export const FacilityFindUniqueArgsSchema: z.ZodType<Prisma.FacilityFindUniqueArgs> = z.object({
  select: FacilitySelectSchema.optional(),
  include: FacilityIncludeSchema.optional(),
  where: FacilityWhereUniqueInputSchema,
}).strict()

export const FacilityFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.FacilityFindUniqueOrThrowArgs> = z.object({
  select: FacilitySelectSchema.optional(),
  include: FacilityIncludeSchema.optional(),
  where: FacilityWhereUniqueInputSchema,
}).strict()
...
export const FacilityCreateArgsSchema: z.ZodType<Prisma.FacilityCreateArgs> = z.object({
  select: FacilitySelectSchema.optional(),
  include: FacilityIncludeSchema.optional(),
  data: z.union([ FacilityCreateInputSchema,FacilityUncheckedCreateInputSchema ]),
}).strict()

export const FacilityUpsertArgsSchema: z.ZodType<Prisma.FacilityUpsertArgs> = z.object({
  select: FacilitySelectSchema.optional(),
  include: FacilityIncludeSchema.optional(),
  where: FacilityWhereUniqueInputSchema,
  create: z.union([ FacilityCreateInputSchema,FacilityUncheckedCreateInputSchema ]),
  update: z.union([ FacilityUpdateInputSchema,FacilityUncheckedUpdateInputSchema ]),
}).strict()

export const FacilityCreateManyArgsSchema: z.ZodType<Prisma.FacilityCreateManyArgs> = z.object({
  data: z.union([ FacilityCreateManyInputSchema,FacilityCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict()

export const FacilityDeleteArgsSchema: z.ZodType<Prisma.FacilityDeleteArgs> = z.object({
  select: FacilitySelectSchema.optional(),
  include: FacilityIncludeSchema.optional(),
  where: FacilityWhereUniqueInputSchema,
}).strict()

export const FacilityUpdateArgsSchema: z.ZodType<Prisma.FacilityUpdateArgs> = z.object({
  select: FacilitySelectSchema.optional(),
  include: FacilityIncludeSchema.optional(),
  data: z.union([ FacilityUpdateInputSchema,FacilityUncheckedUpdateInputSchema ]),
  where: FacilityWhereUniqueInputSchema,
}).strict()

export const FacilityUpdateManyArgsSchema: z.ZodType<Prisma.FacilityUpdateManyArgs> = z.object({
  data: z.union([ FacilityUpdateManyMutationInputSchema,FacilityUncheckedUpdateManyInputSchema ]),
  where: FacilityWhereInputSchema.optional(),
}).strict()

export const FacilityDeleteManyArgsSchema: z.ZodType<Prisma.FacilityDeleteManyArgs> = z.object({
  where: FacilityWhereInputSchema.optional(),
}).strict()